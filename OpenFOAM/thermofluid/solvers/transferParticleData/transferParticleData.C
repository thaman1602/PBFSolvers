...
#   include "createMesh.H"
    ...
    forAll(alphaM.internalField(), cellI){
        ...
        parID.internalField()[cellI] = -1;
    }
    
    //List<label> nCellsInParticles(number, 0);
    ...
    forAll (parID.boundaryField(), patchi)
    {
        // Forced patch assignment.  HJ, 1/Aug/2010.
        parID.boundaryField()[patchi] ==
        parID.boundaryField()[patchi].patchInternalField();
    }
    
    //alphaM.write();
    parID.write();
    //nCellsInParticles.write();
